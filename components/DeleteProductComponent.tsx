...
import { GeneratedCodeBlockDelete } from "./prism/GeneratedCodeBlockDelete";
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-5 gap-4 flex-grow mb-8">
          <div className="md:col-span-3 lg:mr-16">
            <div className="flex items-center gap-x-2">
              <h1 className="text-3xl font-semibold">Delete a Product</h1>
              <ListHoverCard />
            </div>
            <div className="flex items-center gap-x-2">
            ...
            <div className="mt-8 flex lg:justify-start lg:gap-x-[22.5rem] mb-8 justify-between">
