...
import { GeneratedCodeBlockPut } from "./prism/GeneratedCodeBlockPut";
  ...
  return (
    <FormProvider {...form}>
      <form>
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-5 gap-4 flex-grow mb-8">
          <div className="md:col-span-3 lg:mr-16">
            <div className="flex items-center gap-x-2">
              <h1 className="text-3xl font-semibold">Update a Product</h1>
              <ListHoverCard />
            </div>
            <div className="flex items-center gap-x-2">
              <Image src={putIcon} alt="get" width={48} height={48} />
            ...
            <div className="flex flex-col gap-2 border border-sidebar-border p-4 rounded-md bg-sidebar">
              ...
              <div>
                ...
                <VariantsForm
                  ...
                  description="The ID of category."
                  typeName="string"
                  buttonName="ADD STRING"
                  buttonNameMain="ADD OBJECT"
        ...
        <div className="flex lg:justify-start lg:gap-[22.5rem] justify-between mb-8">
          ...
          <Link href="/deleteProduct" className="flex items-center gap-x-2">
            <span className="font-semibold">Delete a product</span>
            <ArrowRight
              height={20}
              className="text-gray-400 hover:cursor-pointer transform transition hover:translate-x-1"
            />
