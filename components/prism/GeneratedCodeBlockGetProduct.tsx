...
export type GeneratedCodeBlockGetProductProps = {
...
const generateGetCodeByLanguage = (
  language: string,
  bearerToken: string,
  productId: string
) => {
...
print(response.text)`;
    ...
    case "http":
      return ` "HTTP": GET /products/${productId} HTTP/1.1
...
export const GeneratedCodeBlockGetProduct = ({
  selectedLanguage,
  bearerToken,
  productId,
}: GeneratedCodeBlockGetProductProps) => {
  ...
  const generatedCode = useMemo(() => {
    return generateGetCodeByLanguage(selectedLanguage, bearerToken, productId);
